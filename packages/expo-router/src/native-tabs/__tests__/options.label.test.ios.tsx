  ...
  it.each([
    {
      ...
      expected: { title: undefined, selectedLabelStyle: { fontSize: 20 } } as NativeTabOptions,
    },
    {
      layout: { hidden: true, selectedStyle: { fontSize: 10 } } as LabelProps,
      dynamic: { children: 'Updated Title' } as LabelProps,
      expected: { title: 'Updated Title', selectedLabelStyle: undefined } as NativeTabOptions,
    },
    {
    ...
    'dynamic <Label> $dynamic overrides whole label configuration from <Label> in _layout $layout',
